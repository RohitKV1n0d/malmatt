...
for i in range(1,472):
    addDetails =   FilterDetails(name=sheet.cell_value(i, 0),gender=sheet.cell_value(i, 1),height=sheet.cell_value(i, 2),
                                weight=sheet.cell_value(i, 3),bloodtype=sheet.cell_value(i, 4),complexion=sheet.cell_value(i, 5),
                                ...
                                kannur=sheet.cell_value(i, 50),kasargod=sheet.cell_value(i, 51))
